...
def test_tensor_loading(
    create_tensor_fn: Callable, warmup_cycle: bool = False, repeat: int = 10, action_player: Type[ActionPlayer] = None
) -> None:
